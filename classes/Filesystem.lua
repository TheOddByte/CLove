--[[
    ...
    I take no credits for this Library, as I've only put together others.
    The credits go to
        Gravityscore for SHA256 implentation
        Alex Kloss for Base64
        SquidDev for AES implentation
--]]
...
--# Base64 by Alex Kloss

Cryptography.Base64 = {}

local b = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'

Cryptography.Base64.encode = function( data )
...
Cryptography.Base64.decode = function( data )
...
Cryptography.SHA256.hash = function( data )
...
--
Cryptography.AES.encrypt = function(password, data, keyLength, mode)
...
Cryptography.AES.decrypt = function( password, data, keyLength, mode )
    local mode = mode or CBCMODE
    local keyLength = keyLength or AES128
